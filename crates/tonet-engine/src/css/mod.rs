...
//! selector model (type / class / id, specificity + source order) for shell integration.
...
pub use author_cascade::{
    cascade_element_rules, cascade_simple_type_rules, parse_simple_prelude,
    prelude_matches_simple_type, SimpleSelectorPrelude,
};
